...
from collective.conference.behavior.address import IAddress
from collective.conference.behavior.contactinfo import INetContactInfo
from collective.conference.behavior.optininformation import IOptInInformation
from collective.conference.content.attendee import IAttendee
from collective.conference.content.registration import IRegistration
from collective.conference.content.registrations import IRegistrations
...
class AddForm(form.SchemaAddForm):
    ...
    grok.require('collective.conference.AddRegistration')
